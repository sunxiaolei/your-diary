...
public class DiaryCalendarView extends View {
    ...
    private void init(Context context) {
        ...
        //Set today text
        mCalendar.onDraw(mCurrentPageCanvas);
    }
    ...
    public boolean doTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (canDragOver()) {
                    if (DragToRight()) {
                        mCalendar.preDateDraw(mNextPageCanvas);
                    } else {
                        mCalendar.nextDateDraw(mNextPageCanvas);
                    }
                    startAnimation(1200);
                } else {
